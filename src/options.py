...
class TrainOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--random_resize", type=int, default=None, help="the shortest side of the original image")
        self.parser.add_argument("--fixed_resize", type=int, default=None, help="resize the original image to a fixed size, i.e., 'crop + fixed_resize'")
        ...
        self.parser.add_argument("--lambda_fft", type=float, default=0.2, help="weight of the fft loss")
