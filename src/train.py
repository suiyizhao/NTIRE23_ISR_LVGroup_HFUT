...
train_dataset = PairedImgDataset(data_source=opt.data_source, mode='train', crop=opt.crop, random_resize=opt.random_resize, fixed_resize=opt.fixed_resize)
...
scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, [500,1000,1500,2000,2500,3000], 0.5)
